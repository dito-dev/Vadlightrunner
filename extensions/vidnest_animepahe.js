const mangayomiSources = [
    {
        ...
        "isNsfw": false,
        "hasCloudflare": false,
        "sourceCodeUrl": "https://raw.githubusercontent.com/RandomUs3rInTh3Int3rn3t/prod_extension2/main/working/vidnest_animepahe.js",
        "isFullData": false,
        "appMinVerReq": "0.5.0",
        "additionalParams": "",
        "sourceCodeLanguage": 1,
        "id": 732918452,
        "notes": "VidNest AnimePahe player",
        "pkgPath": "working/vidnest_animepahe.js"
    }
];
...
class DefaultExtension extends MProvider {
    ...
    async getVideoList(url) {
        console.log("VidNest getVideoList: " + url + " source=VidNest (AnimePahe)");
        try {
            var parts = url.split("||");
            if (parts.length < 2) {
            ...
            var proxyHost = "https://upcloud.animanga.fun";
            var videos = [];
